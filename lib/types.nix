...
# ---------------------------------------------------------------------------- #
  ...
  narHash = lib.liblaika.sha256_sri // {
    name        = "narHash";
  ...
  inputScheme = nt.submodule {
    options = {
      ...
      inputFromURL = lib.mkOption {
       ...
       '';
        type = nt.nullOr ( nt.functionTo ( nt.nullOr lib.liblaika.input ) );
      };
      ...
      toURL = lib.mkOption { type = nt.functionTo lib.liblaika.uri; };
      ...
      applyOverrides = lib.mkOption {
        ...
        '';
        type    = nt.functionTo lib.liblaika.input;
      ...
      fetch = lib.mkOption {
        description = lib.mdDoc ''
          ...
          Note that the `tree` attrset is not a `lib.liblaika.tree` submodule,
          and may also contain arbitrary attributes.
        '';
        type = nt.functionTo ( nt.submodule {
          options.tree  = lib.mkOption { type = nt.package; };
          options.input = lib.mkOption { type = lib.liblaika.input; };
        } );
      };
  ...
  input = nt.submodule {
    options = {
      ...
      scheme = lib.mkOption {
        ...
        '';
        type = nt.nullOr lib.liblaika.inputScheme;
      };
        ...
        type = nt.submodule {
          options = {
            ...
            getNarHash = lib.mkOption {
              ...
              '';
              type    = nt.functionTo ( nt.nullOr lib.liblaika.narHash );
              default = i: let
            ...
            getRev = lib.mkOption {
              ...
              '';
              type    = nt.functionTo ( nt.nullOr lib.liblaika.rev );
            ...
            fetch = lib.mkOption {
              ...
              '';
              type = nt.functionTo ( nt.submodule {
                options.tree   = lib.mkOption { type = lib.liblaika.tree; };
                options.locked = lib.mkOption { type = lib.liblaika.input; };
